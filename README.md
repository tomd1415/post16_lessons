...
- Student work saved with revision history (planned); pupils see only current state.
...
## Known gaps (planned)
- Teacher dashboards, marking, and exports (Phase 4).
- Link registry checks and replacement mapping (Phase 5).
